...
function bytes(i, length, big_endian) {
  length = length || 1;
...
class CatPrinter {
  ...
  constructor(model, write, dry_run) {
      this.model = model;
      this.write = write;
      this.dry_run = dry_run;
      this.pause = new Uint8Array([0x51, 0x78, 0xa3, 0x01, 0x01, 0x00, 0x10, 0x70, 0xff]);
      this.resume = new Uint8Array([0x51, 0x78, 0xa3, 0x01, 0x01, 0x00, 0x00, 0x00, 0xff]);
      this.mtu = 200;
  ...
  make(command, payload, type = CommandType.Transfer) {
